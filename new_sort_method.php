...
<script>
    ...
    var last12WeeksButton = document.getElementById('last12WeeksButton');
    last12WeeksButton.addEventListener('click', function() {
        filterTransactions('last12weeks');
    });

    var last24WeeksButton = document.getElementById('last24WeeksButton');
    last24WeeksButton.addEventListener('click', function() {
        filterTransactions('last24weeks');
    });
