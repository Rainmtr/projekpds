        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3">Product List</h4>
              
              <!-- Search Bar -->
              
                <div method="post" class="col-xs-4 demo-inline-spacing">
                  <input
                    type="text"
                    class="table-search search-control border-0 shadow-none"
                    placeholder="Search..."
                    aria-label="Search..."
                  />
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $rows['qty_on_hand']; ?></td>
