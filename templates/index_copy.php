...
>
  <head>
    ...
    <style>
      ...
      #closeButton, #closeButton_country {
      position: absolute;
      top: 10px;
      right: 10px;
      padding: 8px 16px;
  ...
  <body>
    ...
    <!-- User -->
    <div id="popupContainer_user" class="popup-container">
      <div class="popup-content">
        <button id="closeButton_user">Close</button>
      </div>
    </div>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
                ...
                <div class="col-md-6 col-lg-4 order-0 mb-4">
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="card-title m-0 me-2">Top 5 Country</h5>
                      <div class="dropdown">
                        <button
                          class="btn p-0"
                          type="button"
                    ...
                    <div class="card-body">
                      ...
                      <button id="showPopupButton" onclick="showChartPopup_country()" class="btn btn-primary">Show details</button>
                    </div>
                    <div class="card-body">
                      <ul class="p-0 m-0" id="countryList">
                        <!-- daftar country -->
    ...
    function showChartPopup_country() {
        ...
        top5Countries.forEach(function(country) {
            ...
            if (mostSoldItems) {
                ...
                var mostBoughtItemsPara = document.createElement('h4');
            ...
            if (averageTransactionValue) {
                ...
                var averageValuePara = document.createElement('h4');
